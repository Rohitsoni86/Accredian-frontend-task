...
export default function Home() {
  ...
  useEffect(() => {
    ...
    if (!userDetailsstate.isLoading) {
      ...
      //SetUser(userDetailsstate.userDetailsFetched);
    } else {
  ...
  return (
    <>
      {userDetailsstate.isLoading ? (
        <>
          <h2 className="text-2xl text-black font-bold mt-20">
            Please Login First !!
          </h2>
        </>
      ) : (
              ...
              <div aria-label="header" className="flex space-x-4 items-center p-4">
                <div aria-label="avatar" className="flex mr-auto items-center space-x-4">
                  ...
                  <div className="space-y-2 flex flex-col flex-1 truncate">
                    <div className="font-medium relative text-xl leading-tight text-gray-900">
                      <span className="flex">
                        <span className="truncate relative pr-8">
                         {userDetailsstate.userDetailsFetched.user_name}
                          <span
                            aria-label="verified"
                    ...
                    {userDetailsstate.userDetailsFetched.user_email}
                    </p>
                  </div>
                </div>
                <svg
